      ...
      <div className="flex flex-col items-center justify-center bg-[#0b1c2d] px-6 py-12">
        <div className="w-full max-w-md text-white">
          ...
          <p className="text-gray-300 mb-6">
            Choose the bank connected to your BVN to receive OTP.
          </p>
          ...
          <div className="space-y-3">
            {banks.map((bank) => (
              <div
                key={bank.id}
                className="flex items-center justify-between bg-[#10263f] px-4 py-3 rounded-lg cursor-pointer hover:border hover:border-orange-500"
              >
                <span>{bank.name}</span>
